...
from agent.AgentLstmV2 import AgentLstmV2
...
agent = AgentLstmV2(valence=valence, model=lstm_classifier, optimizer=optimizer, loss_fn=loss_func,
...
save_time_compute(agent.time_train, path="../test02/time_compute.png")
save_evolued_loss(agent.loss_train, path="../test02/evolued_loss.png")
save_evolued_acc(agent.acc_train, path="../test02/evolued_acc.png")
